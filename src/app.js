...
import sessionRouter from './routes/userSessionRouter.js'
import __dirname from './utils/constantsUtil.js';
import websocket from './websocket.js';

//Passport
import {iniciarPassportFinal } from './configuracion/passport.config.js';
...
app.use(cookieParser('Coder2025JSII'));
...
app.use('/api/purchase', compraRouter)
